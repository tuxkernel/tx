...
slashkern=.05em,lowerslash=.05em]{typog} % typoGraphic Fine-Tuning.
...
%\usepackage[cam,width=236mm,height=300mm,center]{crop} % Marcas de corte
% letterpaper: 216mm x 280mm
...
\pgfplotsset{compat=newest} % 1.17 or newest
...
\DeclareFloatingEnvironment[fileext=lom,listname={Índice de mapas},name=Mapa,within=none,chapterlistsgaps=off]{map}
\DeclareFloatingEnvironment[fileext=lop,listname={Índice de foto},name=Foto,within=none,chapterlistsgaps=off]{photo}
...
\hypersetup{
pdfcopyright={© 2007-2026. Noel Merino Hernández. Algunos derechos reservados. Este documento se proporciona como es, sin ningún tipo de garantía, aunque se espera que pueda ser útil, y se distribuye bajo Do What The Fuck You Want To Public License (WTFPL), versión 2 o posterior. Por lo tanto, todos son absolutamente libres de hacer de este documento lo que quieran.},
pdflicenseurl={http://www.wtfpl.net/about/},
}
...
\vfill
\protect\phantomsection
\addcontentsline{toc}{chapter}{Licencia del documento}
\addtocontents{toc}{\vspace{\normalbaselineskip}} % Add some vertical space between titles in TOC
\begin{scriptsize}
\begin{flushleft}
...
\def\fileversion{1.060}
\def\filedate{(01--01--2026)}
\href{https://tuxkernel.github.io/tx/dl/cv.txt}{versión\space\fileversion\space\filedate} \protect\medskip

Copyright \textcopyright\ 2007--2026. \href{noel_merino@yahoo.com.mx}{Noel Merino Hernández} (del texto).

Copyright \textcopyright\ 2022--2026. \href{muxkernel@gmail.com}{Tuxkernel} (de la composición tipográfica). \protect\medskip
...
la «nueva» (2026) en:
\begin{center}
\href{https://tuxkernel.github.io/tx/dl/thesis-2026.pdf}{\bfseries https://tuxkernel.github.io/tx/dl/thesis-2026.pdf}
\end{center}
...
\begin{center}
\bfseries (Merino, 2026 [2007], p. 13)
\end{center}
\noindent Lo anterior indica que estas citando la página 13 de la versión 2026, pero cuyo contenido está basado en la de 2007; solo adapta el ejemplo anterior a tu modelo de citación. Si te resulta «compleja» esta nueva modalidad para citar, usa la versión «original» (2007) y punto.
...
\end{flushright}
\bigskip
A \textls[50]{RMS}, \textls[50]{LT} e \textls[50]{IM}.\textsuperscript{\fontencoding{TS1}\selectfont\char100} A \textls[50]{KB} y a \textls[50]{PB}.

A \textls[50]{DEK}, \textls[50]{LL} y \textls[50]{HTT}; sin su trabajo, esta «nueva» \emph{composición} simplemente no existiría.

A los \emph{h4ck3rs} que existen \emph{out there,} especialmente a \textls[50]{FM}, \textls[50]{RF},\textsuperscript{\fontencoding{TS1}\selectfont\char100} \textls[50]{SR},\textsuperscript{\fontencoding{TS1}\selectfont\char100} \textls[50]{WL}, \textls[50]{JBL}, \textls[50]{MS}, \textls[50]{DA}, \textls[50]{GN}, \textls[50]{WAS},\textsuperscript{\fontencoding{TS1}\selectfont\char100} \textls[50]{PW}, \textls[50]{HO}, \textls[50]{TT}, \textls[50]{EG}, \textls[50]{PL}, \textls[50]{JW}, \textls[50]{RS}, \textls[50]{CLS}, \textls[50]{HU}, \textls[50]{RN}, \textls[50]{SIB}, \textls[50]{PVO}, \textls[50]{KW}, \textls[50]{DC}, \textls[50]{TT}, \textls[50]{UK}, \textls[50]{CF}, \textls[50]{YX}, \textls[50]{PI}, \textls[50]{TFS}, \textls[50]{SF}, \textls[50]{ØB}, \textls[50]{JL}, \textls[50]{LB}, \textls[50]{AL}, \textls[50]{AS}, \textls[50]{AB}, \textls[50]{MU} y \textls[50]{SP}.
...
\bottomrule
\end{tabular}
\caption*{\textsc{Fuente:} Blázquez, \emph{op. cit.,} 1986a, tomo \textsc{ii}, pp. 701 y 845; tomo \textsc{iii}, p. 1724. \textsu{*} \emph{v.} Cuadro~\ref{tab:poblacion-anos}, p.~\pageref{tab:poblacion-anos}. \ding{43} \url{https://tuxkernel.github.io/tx/dl/plot2.pdf}}
...
\bottomrule
\end{tabular}
\caption*{\textsc{Fuente:} García, \emph{Jefes...,} p. 367. \ding{43} \url{https://tuxkernel.github.io/tx/dl/plot3.pdf}}
...
diversas leyes tratando de beneficiar a las comunidades indígenas, pero en su rápida aplicación no hicieron más que generar entuertos. Todo parece indicar que el reparto de los terrenos comunales en el cantón de Jalacingo\index[lugares]{Jalacingo!cantón} nunca se resolvió totalmente durante el Porfiriato, siendo los gobiernos posrevolucionarios los que lo heredarían.\protect\phantomsection\label{para:errata}

\begin{linenumbers}
\rightlinenumbers % pone los números en el margen derecho sin afectar la opción switch
\modulolinenumbers[4] % inicia en la línea 4
Frente a los exiguos logros en cuanto al reparto de los terrenos comunales, la venta de terrenos baldíos\index[lugares]{Jalacingo!terrenos baldíos} tuvo mejores resultados (\emph{v.} Cuadro~\ref{tab:venta-terrenos-baldios}, pág.~\pageref{tab:venta-terrenos-baldios}). Tan sólo en el municipio de Atzalan\index[lugares]{Atzalan!terrenos baldíos} fueron repartidas, en diferentes fechas, al menos 171\,273 ha\llabel{cuatro} a diferentes individuos nacionales y extranjeros, lo que vendría a acentuar el aumento de las grandes propiedades durante el Porfiriato.\footnote{Se repartieron más terrenos baldíos pero las autoridades no las consignaron por tratarse de pequeñas propiedades.} Hubo una disparidad en la adjudicación de los baldíos. Las 658~ha\llabel{siete} que se adjudicaron a José Cazzasa (sic),\index[nombres]{Cazzasa, Jose@Cazzasa, José} eran mínimas en comparación con las 62\,811 ha\llabel{ocho} que se le otorgaron a Roberto Guzmán,\index[nombres]{Guzman, Roberto@Guzmán, Roberto} un próspero comerciante, reconocido usurero y miembro de la élite local del poblado de Atzalan.\index[lugares]{Atzalan!poblado} Aparte de las dimensiones superficiales de los baldíos,\index[lugares]{Atzalan!terrenos baldíos} debe tenerse en cuenta su riqueza agropecuaria. Se trataba de terrenos ubicados en la zona caliente del cantón,\index[lugares]{Jalacingo!cantón} con abundante agua, aptos para el cultivo de la vainilla, el tabaco, el café, la caña de azúcar y la engorda de ganado mayor, productos con una fuerte demanda en el mercado nacional e internacional.
\end{linenumbers}
\begin{table}%[H]
\centering
...
\centering
\caption[\emph{El Progreso Industrial} de Pedro Pradal e hijos (1902)]{\emph{El Progreso Industrial}\index[lugares]{Progreso Industrial, El!\emph{Foto}} de Pedro Pradal\index[nombres]{Pradal, Pedro} e hijos (1902).}
\includegraphics[width=16.6cm]{progreso-industrial} % 16.6cm
...
\begin{tabular}{@{}llccc@{}}
\toprule
\multirow{3}{*}{Fábrica} & \multirow{3}{*}{Propietario} & \multicolumn{2}{c}{Productos} & \multirow{3}{*}{Valor (\$)} \\
\cmidrule{3-4}
{} & {} & Aguardiente & Panela & {} \\
{} & {} & (Barriles) & (Arrobas) & {} \\
\midrule
Texcayapan\index[lugares]{Texcayapan!fábrica} & José María Landa\index[nombres]{Landa, Jose Maria@Landa, José María} & 48 & 480 & 240 \\
El Arco\index[lugares]{Arco, El!fábrica} & Antonio Barrientos\index[nombres]{Barrientos, Antonio} & 48 & 480 & 240 \\
\bottomrule
\end{tabular}
\caption*{\textsc{Fuente:} Blázquez, \emph{Estado...,} tomo \textsc{ii}, s/f.; tomo \textsc{viii}, p. 14.}
...
\includegraphics[width=16.2cm]{jalacingo-foto} % 16.2cm
...
\end{axis}
\end{tikzpicture}
\caption*{\textsc{Fuente:} \textsc{agnep}, 1876--1910; \textsc{arppj}, 1872--1910. Cfr. Cuadro~\ref{tab:operaciones-fam-villegas}, pág.~\pageref{tab:operaciones-fam-villegas}; Imagen~\ref{fig:porcentajes}, pág.~\pageref{fig:porcentajes}.}
...
\end{tikzpicture}
\caption*{\textsc{Fuente:} \textsc{agnep}, 1876--1910; \textsc{arppj}, 1872--1910. Cfr. Cuadro~\ref{tab:operaciones-fam-villegas}, pág.~\pageref{tab:operaciones-fam-villegas}.}
...
\toprule
Acreedor & Deudor(es) & \textsc{p} (\$)\textsu{\emph{a}} & {\textsc{t}\textsu{\em b}} & \textsc{tia} (\percentsign)\textsu{\emph{c}} & \textsc{r} (\$)\textsu{\em d} & Garantía \\
\midrule
\endhead
\bottomrule
% Pie de la tabla
...
Acreedor & Deudor(es) & \textsc{p} (\$)\textsu{\emph{a}} & {\textsc{t}\textsu{\em b}} & \textsc{tia} (\percentsign)\textsu{\emph{c}} & \textsc{r} (\$)\textsu{\em d} & Garantía \\
\midrule
J. A. Villegas Contreras\index[nombres]{Villegas Contreras, Jose Antonio@Villegas Contreras, José Antonio} & Ignacio Danini\index[nombres]{Danini, Ignacio} e Isidoro O. Marié\index[nombres]{Marie, Isidoro O.@Marié, Isidoro O.} & 20000 & 8 & 12 & 19200 & Hda. San Miguel del Rincón\index[lugares]{San Miguel del Rincon@San Miguel del Rincón!hacienda} \\
J. A. Villegas Contreras & Ignacio Danini e Isidoro o. Marié & 10000 & 3 & 12 & 3600 & Hda. San Miguel del Rincón \\
J. A. Villegas Contreras & Miguel Valdés\index[nombres]{Valdes, Miguel@Valdés, Miguel} & 4000 & 3 & 12 & 1440 & Rancho Buenavista\index[lugares]{San Pedro Buenavista!rancho} \\
J. A. Villegas Contreras & Nicolás Velázquez\index[nombres]{Velazquez, Nicolas@Velázquez, Nicolás} & 3000 & 3 & 12 & 1080 & Casa \\
Q. Villegas Contreras\index[nombres]{Villegas Contreras, Quirino} & José María Calderón\index[nombres]{Calderon, Jose Maria@Calderón, José María} & 400 & & & & Casa \\
J. A. Villegas Contreras & Leonardo M. de Rugama\index[nombres]{Rugama, Leonardo} & 1436 & & & & Hda. de Tenextepec\index[lugares]{Tenextepec!hacienda} \\
J. A. Villegas Contreras & José Huici\index[nombres]{Huici, Jose@Huici, José} y Cástula Naveda\index[nombres]{Naveda, Castula@Naveda, Cástula} & 1000 & 2 & 12 & 240 & Casa \\
J. A. Villegas Contreras & Manuel\index[nombres]{Lopez Leon, Manuel@López León, Manuel} y Herminia López León\index[nombres]{Lopez Leon, Herminia@López León, Herminia} & 7000 & 3 & 12 & 2520 & Casa y terreno \\
J. A. Villegas Contreras & Fco. Calderón\index[nombres]{Calderon, Francisco@Calderón, Francisco} y Dolores Ríos\index[nombres]{Rios, Dolores@Ríos, Dolores} & 6000 & 6 & 12 & 4320 & Casa \\
J. A. Villegas Contreras & Fco. Calderón y Dolores Ríos & 7000 & 7 & 12
& 5880 & Casa \\
J. A. Villegas Contreras & Victorino\index[nombres]{Bando, Victorino} y Leonardo Bando\index[nombres]{Bando, Leonardo} & 3000 & 3 & 12 & 1080 & Pahuatatempa\index[lugares]{Pahuatatempa!hacienda} y anexos Xaltepec\index[lugares]{Xaltepec!rancho} y Tachitepec\index[lugares]{Tachitepec!rancho} \\
J. A. Villegas Contreras & Victorino y Leonardo Bando & 2550 & 5 & 10 & 1275 & Pahuatatempa y anexos Xaltepec y Tachitepec \\
José María Villegas\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & A. Murrieta\index[nombres]{Murrieta, Antonio} y J. Romero\index[nombres]{Romero, Josefa} & 390 & & & & Terreno \\
Q. Villegas Contreras\index[nombres]{Villegas Contreras, Quirino} & José Luis Huici\index[nombres]{Huici, Jose@Huici, José} & 1686 & & & & Trabajo \\
Q. Villegas Contreras & Gertrudis Fernández\index[nombres]{Fernandez de Vinals, Gertrudis@Fernández de Viñals, Gertrudis} & 17000 & 3 & 12 & 6120 & Casa \\
José María Villegas\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & M\textsu{a} N. Mendoza\index[nombres]{Mendoza, Maria Natividad@Mendoza, María Natividad} y Clotilde Ayala\index[nombres]{Ayala, Clotilde} & 2000 & 2 & 12 & 720 & Casa \\
J. A. Villegas Contreras\index[nombres]{Villegas Contreras, Jose Antonio@Villegas Contreras, José Antonio} & Claudio Antonio Limón\index[nombres]{Limon, Claudio Antonio@Limón, Claudio Antonio} & 40000 & & 5 & 2000 & Hda. San Antonio Limón\index[lugares]{San Antonio Limon@San Antonio Limón!hacienda} y anexos \\
J. A. Villegas Contreras & Fco. Hernández\index[nombres]{Hernandez, Francisco@Hernández, Francisco} & 30000 & 3 & 6 & 5400 & Hda. de Cuautotolapam\index[lugares]{Cuautotolapam!hacienda} \\
J. A. Villegas Contreras & José Gandara\index[nombres]{Gandara, Jose@Gandara, José} & 2000 & 2 & 6 & 240 & Casas y terrenos \\
J. A. Villegas Contreras & Miguel Locela\index[nombres]{Locela, Miguel} & 1000 & 4 & 6 & 240 & Casa y terrenos \\
J. A. Villegas Contreras & Santiago Flores\index[nombres]{Flores, Santiago} & 350 & 3 & 1 & 10 & Casa \\
J. Villegas del Campo\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & Manuel de Alcalde\index[nombres]{Alcalde, Manuel de} & 678 & & 6 & 40 & Rancho \\
J. Villegas del Campo & Bacilio Bello\index[nombres]{Bello, Bacilio} & 1147 & 2 & {} & {} & Rancho \\
J. Villegas del Campo & Manuel de Alcalde & 773 & 1.5 & 24 & 241 & Rancho y terrenos \\
Josefa Villegas Contreras\index[nombres]{Villegas Contreras, Josefa} & Feliciano Mendoza\index[nombres]{Mendoza, Feliciano} & 230 & 2 & {} & {} & Rancho \\
Carmen Villegas Guzmán\index[nombres]{Villegas Guzman, Carmen@Villegas Guzmán, Carmen} & Miguel María de Guzmán\index[nombres]{Guzman, Miguel Maria de@Guzmán, Miguel María de} & 2961 & {} & {} & {} & Terreno \\
Q. Villegas Contreras & Miguel María de Guzmán & 3500 & 2 & {} & {} & Casa \\
J. A. Villegas Contreras & Ignacio Bustos\index[nombres]{Bustos, Ignacio} & 1522 & 1 & 12 & 182 & Fincas \\
J. A. Villegas Contreras & Juan del Campo\index[nombres]{Campo, Juan del} e hijos & 2733 & 2 & 6 & 164 & Casa \\
J. Villegas del Campo & Bacilio Bello e hijos & 1500 & 6 & {} & {} & Rancho \\
J. Villegas del Campo & Manuel Y. Bello\index[nombres]{Bello, Manuel} & 789 & {} & {} & {} & Rancho \\
J. A. Villegas Contreras & José de Jesús López\index[nombres]{Lopez, Jose de Jesus@López, José de Jesús} & 365 & {} & {} & {} & Casa \\
J. A. Villegas Contreras & Miguel Valdés\index[nombres]{Valdes, Miguel@Valdés, Miguel} & 4000 & 3 & 12 & 1440 & Rancho Buenavista\index[lugares]{San Pedro Buenavista!rancho} \\
J. A. Villegas Contreras & Nicolás Velázquez\index[nombres]{Velazquez, Nicolas@Velázquez, Nicolás} & 3000 & 3 & 12 & 1080 & Casa \\
M. L. Villegas Perdomo\index[nombres]{Villegas Perdomo, Mariano Lauro} & Juan Cuevas\index[nombres]{Cuevas, Juan} & 200 & {} & {} & {} & Casa \\
M. L. Villegas Perdomo & Rafaela García\index[nombres]{Garcia, Rafaela@García, Rafaela} & 116 & {} & {} & {} & Casa \\
M. L. Villegas Perdomo & Manuela de Jesus\index[nombres]{Jesus, Manuela de@Jesús, Manuela de} & 25 & {} & {} & {} & Casa \\
M. Villegas del Campo & José Hernández Mondragón\index[nombres]{Hernandez Mondragon, Jose@Hernández Mondragón, José} & 492 & {} & {} & {} & Rancho \\
M. L. Villegas Perdomo & Ventura Calixto\index[nombres]{Calixto, Ventura} & 67 & {} & {} & {} & Rancho \\
J. A. Villegas Contreras & Alejandro Marín\index[nombres]{Marin, Alejandro@Marín, Alejandro} & 4000 & {} & 5 & 200 & Rancho «Arroyo Zarco»\index[lugares]{Arroyo Zarco!rancho} \\
...
M. L. Villegas Perdomo & Aniceto González\index[nombres]{Gonzalez, Aniceto@González, Aniceto} & 140 & 1 & {} & {} & Rancho \\
M. L. Villegas Perdomo & Manuel Bandala\index[nombres]{Bandala, Manuel} & 108 & {} & {} & {} & Rancho y casa \\
M. L. Villegas Perdomo & Miguel Murrieta\index[nombres]{Murrieta, Manuel} & 110 & {} & {} & {} & Terreno \\
M. L. Villegas Perdomo & Bernardo Morales\index[nombres]{Morales, Bernardo} & 55 & {} & {} & {} & Terrenos \\
J. A. Villegas Contreras & Miguel María de Guzmán & 2000 & 0.25 & 12 & 60 & Casa \\
M. L. Villegas Perdomo & José\index[nombres]{Luciano, Jose@Luciano, José} y Antonio Pedro Luciano\index[nombres]{Luciano, Antonio Pedro} & 60 & {} & {} & {} & Terrenos \\
J. A. Villegas Contreras & Adolfo B. Carsi\index[nombres]{Carsi, Adolfo B.} & 25000 & 5 & 12 & 15000 & Hda. «El Pital»\index[lugares]{Pital, El!hacienda} \\
J. A. Villegas Contreras & Juan\index[nombres]{Garcia, Juan@García, Juan} y José Antonio García\index[nombres]{Garcia, Jose Antonio@García, José Antonio} & 5725 & 0.25 & 12 & 50 & Terrenos y casa \\
M. L. Villegas Perdomo & Marcos Mendoza\index[nombres]{Mendoza, Marcos} y esposa & 199 & 1 & {} & {} & Terrenos \\
M. L. Villegas Perdomo & Miguel Juárez\index[nombres]{Juarez, Miguel@Juárez, Miguel} & 76 & {} & {} & {} & Terrenos \\
J. A. Villegas Contreras & Luciano\index[nombres]{Hernandez, Luciano@Hernández, Luciano} y Gabriel E. Hernández\index[nombres]{Hernandez, Gabriel E.@Hernández, Gabriel E.} & 6000 & 0.5 & 12 & 360 & Rancho «Santa Ana Moluapan»\index[lugares]{Santa Ana Moloapan!rancho} \\
M. L. Villegas Perdomo & Josefa Serrano\index[nombres]{Serrano, Josefa} & 141 & 1 & {} & {} & Terrenos y casas \\
J. M. Villegas del Campo & Manuela Gómez de la Torre\index[nombres]{Gomez de la Torre, Manuela@Gómez de la Torre, Manuela} & 3000 & 0.5 & 12 & 180 & Hda. Santa Cruz\index[lugares]{Santa Cruz!hacienda} y rancho San Luis\index[lugares]{San Luis!rancho} \\
J. A. Villegas Contreras & Luis Marín\index[nombres]{Marin, Luis@Marín, Luis} & 9000 & 0.5 & 12 & 540 & Casas, terrenos, etc. \\
Miguel Villegas\index[nombres]{Villegas, Miguel} & Pascual Mendoza\index[nombres]{Mendoza, Pascual} & 200 & 0.5 & {} & {} & Rancho \\
J. A. Villegas Contreras & M\textsu{a} de Jesús Carrión\index[nombres]{Carrion, Maria de Jesus@Carrión, María de Jesús} y Nicolás Soto\index[nombres]{Soto, Nicolas@Soto, Nicolás} & 500 & 1 & {} & {} & Casa \\
L. Villegas Perdomo\index[nombres]{Villegas Perdomo, Leonardo} & M. Mendoza\index[nombres]{Mendoza, Manuela} y Fco. Alonso Espinoza\index[nombres]{Alonso Espinoza, Francisco} & 67 & {} & {} & {} & Terrenos y jacales \\
J. A. Villegas Contreras & Ignacio Perdomo\index[nombres]{Perdomo, Ignacio} & 4000 & 1 & 6 & 240 & Casa \\
J. A. Villegas Contreras & Felipe Revuelta\index[nombres]{Revuelta, Felipe} & 4000 & 1 & 9 & 360 & Casa y terrenos \\
J. A. Villegas Contreras & Felipe Revuelta & 3000 & 0.5 & 9 & 135 & Casa y terrenos \\
J. A. Villegas Contreras & Luciano y Gabriel E. Hernández & 13000 & 1 & 9 & 1170 & Hda. «Santa Ana Moluapan» y «El Mirador»\index[lugares]{Mirador, El!rancho} \\
J. A. Villegas Contreras & Joaquín Hoyos\index[nombres]{Hoyos, Joaquin@Hoyos, Joaquín} y Dolores Vázquez\index[nombres]{Vazquez, Dolores@Vázquez, Dolores} & 3000 & 0.5 & {} & {} & Rancho «Teacal»\index[lugares]{Teacal!rancho} \\
J. A. Villegas Contreras & Ana Rugama de Cruz\index[nombres]{Rugama de Cruz, Ana} y Carlos Cruz Rugama\index[nombres]{Cruz Rugama, Carlos} & 53000 & 10 & 6 & 31800 & Hda. Tenextepec\index[lugares]{Tenextepec!hacienda} y anexos; casa en Puebla \\
J. A. Villegas Contreras & Luis Marín & 15000 & 1 & 6 & 900 & Terrenos «Planes de Almanza»\index[lugares]{Almanza!Planes de} \\
J. A. Villegas Contreras & Benjamín González\index[nombres]{Gonzalez, Benjamin@González, Benjamín} y esposa & 26185 & 4 & 6 & 6284 & Casas y terrenos \\
J. M. Villegas del Campo & Andrés Rodríguez\index[nombres]{Rodriguez, Andres@Rodríguez, Andrés} & 600 & 1 & 18 & 108 & Terrenos \\
J. M. Villegas del Campo & Benigno Ríos\index[nombres]{Rios, Benigno@Ríos, Benigno} & 6000 & 5 & 12 & 3600 & Hda. «Santa Cruz y anexos» \\
J. M. Villegas del Campo & Miguel Locela herederos\index[nombres]{Locela, Miguel!herederos} & 1400 & 2 & 12 & 336 & Casa \\
J. M. Villegas del Campo & Roberto Guzmán\index[nombres]{Guzman, Roberto@Guzmán, Roberto} & 5000 & 4 & 12 & 2400 & Rancho «Progreso»\index[lugares]{Progreso, El!rancho} y anexos; cafetales \\
J. M. Villegas del Campo & Luis Condado Velis\index[nombres]{Condado Velis, Luis} & 2000 & {} & {} & {} & Terrenos \\
J. A. Villegas Contreras & José Gandara & 2670 & 2 & 6 & 320 & Terrenos \\
J. M. Villegas del Campo & Bartolomé Sánchez\index[nombres]{Sanchez, Bartolome@Sánchez, Bartolomé} & 17800 & {} & 12 & 2132 & Terrenos \\
J. A. Villegas Contreras & Enrique Mendoza\index[nombres]{Mendoza, Enrique} & 3000 & 3 & 6 & 540 & Casa \\
J. A. Villegas Contreras & Fam. Flores\index[nombres]{Flores!familia} y Rosendo R. Velázquez\index[nombres]{Velazquez, Rosendo@Velázquez, Rosendo} & 20000 & 6 & 6 & 7200 & Casas y terrenos \\
J. M. Villegas del Campo & Mariano Rivera\index[nombres]{Rivera, Mariano} & 2000 & 3 & 12 & 720 & Terrenos y casas \\
J. M. Villegas del Campo & Antonio Murrieta Morales\index[nombres]{Murrieta Morales, Antonio} & 2815 & 4 & 12 & 1351 & Terrenos y casas \\
J. M. Villegas del Campo & José Antonio García & 650 & 2 & 12 & 156 & Terrenos y casas \\
J. M. Villegas del Campo & Fco. García González\index[nombres]{Garcia Gonzalez, Francisco@García González, Francisco} & 350 & 2 & 24 & 168 & Terrenos \\
Guadalupe Villegas del Campo\index[nombres]{Villegas del Campo, Guadalupe} & Juan Cuevas & 1200 & 3 & {} & {} & Terrenos \\
J. M. Villegas del Campo & Cosme Benavides\index[nombres]{Benavides, Cosme} & 1000 & 2 & 15 & 300 & Rancho \\
J. M. Villegas del Campo & Miguel\index[nombres]{Tejeda Fernandez, Miguel@Tejeda Fernández, Miguel} y Micaela Tejeda Fernández\index[nombres]{Tejeda Fernandez, Micaela@Tejeda Fernández, Micaela} & 190 & {} & {} & {} & Terreno \\
J. M. Villegas del Campo & José Antonio García & 4400 & 5 & 12 & 2640 & Rancho «Nansolco»\index[lugares]{Nansolco!rancho} \\
J. M. Villegas del Campo & María de Jesús Mendoza\index[nombres]{Mendoza, Maria de Jesus@Mendoza, María de Jesús} & 4300 & 4 & 10 & 1720 & Casa \\
J. M. Villegas del Campo & Fam. Parra Mendoza\index[nombres]{Parra Mendoza!familia} & 10000 & 3 & 10 & 3000 & Rancho «Tepantepec»\index[lugares]{Tepantepec!rancho} y casa \\
J. M. Villegas del Campo & S. Mota,\index[nombres]{Mota, Santiago} Manuel L. Glez.\index[nombres]{Gonzalez, Manuel L.@González, Manuel L.} y Porfirio Aburto\index[nombres]{Aburto, Porfirio} & 4985 & 3 & 9 & 1346 & Casas \\
J. M. Villegas del Campo & Estanislao Galván Monfil\index[nombres]{Galvan Monfil, Estanislao@Galván Monfil, Estanislao} & 9000 & 2 & {} & {} & Rancho «Progreso» \\
J. M. Villegas del Campo & Estanislao Galván Monfil & 17000 & {} & {} & {} & Rancho «Progreso» y «Naranjillo»\index[lugares]{Naranjillo!rancho} \\
J. M. Villegas del Campo & Manuel L. González & 1000 & 3 & 9 & 270 & Casa \\
J. M. Villegas del Campo\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & Santiago Mota\index[nombres]{Mota, Santiago} & 4108 & 3 & 6 & 739 & Casa y terreno \\
L. Villegas Perdomo\index[nombres]{Villegas Perdomo, Leonardo} & J. M. Villegas Contreras & 577 & {} & {} & {} & Terrenos \\
J. A. Villegas Sucs.\index[nombres]{Villegas Contreras, Jose Antonio@Villegas Contreras, José Antonio!sucesores} & José María Murrieta\index[nombres]{Murrieta, Jose Maria@Murrieta, José María} & 11964 & 8 & 6 & 5742 & Terrenos \\
J. A. Villegas Sucs. & Miguel Murrieta\index[nombres]{Murrieta, Miguel} & 2900 & {} & {} & {} & Terreno \\
J. A. Villegas Sucs. & Rosalino Moreno\index[nombres]{Moreno, Rosalino} & 1525 & {} & {} & {} & Terreno \\
J. A. Villegas Sucs. & Pedro Méndez\index[nombres]{Mendez, Pedro@Méndez, Pedro} & 2759 & {} & {} & {} & {} \\
\midrule
{} & {} & 509087 & {} & {} & 155002 & {} \\
\bottomrule
\caption*{\textsc{Fuente:} \textsc{agnep}, 1876--1910; \textsc{arppj}, 1872--1910. \\ \textsu{\em a} \textsc{p} = préstamo. \\ \textsu{\em b} \textsc{t} = tiempo (en años). \\ \textsu{\em c} \textsc{tia}~= tasa de interés anual. \\ \textsu{\em d} \textsc{r} = rendimiento.}
...
\bottomrule
\end{tabular}
\caption*{\textsc{Fuente:} \textsc{agnep}, 1876--1910; \textsc{arppj}, 1872--1910. Cfr. Imágenes \ref{fig:operaciones-villegas}--\ref{fig:porcentajes}, págs.~\pageref{fig:operaciones-villegas}--\pageref{fig:porcentajes}.}
...
\hangpara{1cm}{1}\textsc{Juárez Martínez}, Abel, «El trabajo en la hacienda de San José de los Molinos, en Veracruz (1890--1910)» en \textsc{Cerutti}, Mario (Coord.), \emph{De los Borbones a la Revolución. Ocho estudios regionales.} \textsc{comecso/gv} editores/\textsc{uanl}, México, 1986, pp.~181--211.
...
\cmidrule{2-6}
{} & real & medio real (\textfrac{1}{2}) & cuartilla (\textfrac{1}{4}) & tlaco (\textfrac{1}{8}) &   \multicolumn{1}{c}{pilón (\textfrac{1}{16})} \\
\midrule
Real & 1 & 2 & 4 & 8 & 16 \\
Medio real & {} & 1 & 2 & 4 & 8 \\
Cuartilla & {} & {} & 1 & 2 & 4 \\
...
\end{table}
Los datos de la tercera columna (Hectáreas) del Cuadro~\ref{tab:venta-terrenos-baldios} (pág.~\pageref{tab:venta-terrenos-baldios}) son erróneos. Decidimos dejarlos tal cuales y de manera \emph{intencional,} para que la «nueva» composición (2026) reprodujera fielmente los yerros de la versión del 2007 (\ding{43} \nameref{ch:nota-preliminar}). Ofrecemos aquí, ya corregidos, los nuevos valores de dicho cuadro.
...
\fancyhf{} % Remueve los encabezados y pies previos. Necesario sí o sí.
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872--1910} % Centrados
\fancyhead[CO]{\small\sc apéndice d: aviso legal} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
...
\noindent Copyright \textcopyright\ 1578--2026. Benemérita Universidad Autónoma de Puebla (pág.~\pageref{fig:buap}).

\noindent Copyright \textcopyright\ 1991--2026. Instituto de Ciencias Sociales y Humanidades (pág.~\pageref{fig:icsyh}). \\

\noindent Licencia: \\

\noindent Copyright \textcopyright\ 2004--2026. Do What The Fuck You Want To Public License (pág. \pageref{fig:wtfpl}). \\

\noindent Capítulo 1: \\

\noindent Copyright \textcopyright\ 1987--2026. María de la Luz Belmonte Guzmán (pág. \pageref{fig:veracruz-1857}).

\noindent Copyright \textcopyright\ 1992--2026. Luc Cambrezy y Bernal Lascurain (pág. \pageref{fig:jalacingo-principios-xx}).

\noindent Copyright \textcopyright\ 1988--2026. Archivo General del Estado de Veracruz (pág. \pageref{fig:progreso-industrial}). \\

\noindent Capítulo 2: \\

\noindent Copyright \textcopyright\ 2007--2026. Eugenio Pedro José Pradal Roa (pág. \pageref{fig:jalacingo-photo}).

\noindent Capítulo 3: \\

\noindent Copyright \textcopyright\ 1992--2026. Luc Cambrezy y Bernal Lascurain (pág. \pageref{fig:hda-limon}).

\noindent Copyright \textcopyright\ 1992--2026. Luc Cambrezy y Bernal Lascurain (pág. \pageref{fig:hda-cuatotolapam}).

\noindent Copyright \textcopyright\ 1992--2026. Luc Cambrezy y Bernal Lascurain (pág. \pageref{fig:hda-tenextepec}). \\

\noindent Colofón: \\

\noindent Copyright \textcopyright\ 2007--2026. Eugenio Pedro José Pradal Roa, detalle (pág. \pageref{fig:vineta}). \\
...
Cochineal\texttrademark\ es una marca registrada de Michael Sharpe, y su tipografía se distribuye bajo una licencia \textls[50]{SIL} Open Font.\enlargethispage{\baselineskip}
