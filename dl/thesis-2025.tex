...
\def\fileversion{1.059}
\def\filedate{(24--09--2025)}
...
\end{table}
Los datos de la tercera columna (Hectáreas) del Cuadro~\ref{tab:venta-terrenos-baldios} (pág.~\pageref{tab:venta-terrenos-baldios}) son erróneos. Decidimos dejarlos tal cuales y de manera \emph{intencional,} para que la «nueva» composición (2025) reprodujera fielmente los yerros de la versión del 2007 (\ding{43} \nameref{ch:nota-preliminar}). Ofrecemos aquí, ya corregidos, los nuevos valores de dicho cuadro.
