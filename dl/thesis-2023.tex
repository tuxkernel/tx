...
\includegraphics[width=2.5cm]{cc-srr}\label{fig:cc-srr} \protect\medskip

\includegraphics[width=2.5cm]{cc-large}\phantomsection\label{fig:cc} \protect\medskip

\def\fileversion{1.038}
\def\filedate{(16-11-2023)}
...
Acreedor & Deudor(es) & \textsc{p} (\$)\textsu{\emph{a}} & \textsc{t}\textsu{\em b} & \textsc{tia} (\char37) & \textsc{r} (\$)\textsu{\em c} & Garantía \\
\midrule
J. A. Villegas Contreras\index[nombres]{Villegas Contreras, Jose Antonio@Villegas Contreras, José Antonio} & Ignacio Danini\index[nombres]{Danini, Ignacio} e Isidoro O. Marié\index[nombres]{Marie, Isidoro O.@Marié, Isidoro O.} & \texttlf{20000} & \textlf{8} & \texttlf{12} & \texttlf{19200} & Hda. San Miguel del Rincón\index[lugares]{San Miguel del Rincon@San Miguel del Rincón!hacienda} \\
J. A. Villegas Contreras & Ignacio Danini e Isidoro o. Marié & \texttlf{10000} & \textlf{3} & \texttlf{12} & \texttlf{3600} & Hda. San Miguel del Rincón \\
J. A. Villegas Contreras & Miguel Valdés\index[nombres]{Valdes, Miguel@Valdés, Miguel} & \texttlf{4000} & \textlf{3} & \texttlf{12} & \texttlf{1440} & Rancho Buenavista\index[lugares]{San Pedro Buenavista!rancho} \\
J. A. Villegas Contreras & Nicolás Velázquez\index[nombres]{Velazquez, Nicolas@Velázquez, Nicolás} & \texttlf{3000} & \textlf{3} & \texttlf{12} & \texttlf{1080} & Casa \\
...
J. A. Villegas Contreras & José Huici\index[nombres]{Huici, Jose@Huici, José} y Cástula Naveda\index[nombres]{Naveda, Castula@Naveda, Cástula} & \texttlf{1000} & \textlf{2} & \texttlf{12} & \texttlf{240} & Casa \\
J. A. Villegas Contreras & Manuel\index[nombres]{Lopez Leon, Manuel@López León, Manuel} y Herminia López León\index[nombres]{Lopez Leon, Herminia@López León, Herminia} & \texttlf{7000} & \textlf{3} & \texttlf{12} & \texttlf{2520} & Casa y terreno \\
J. A. Villegas Contreras & Fco. Calderón\index[nombres]{Calderon, Francisco@Calderón, Francisco} y Dolores Ríos\index[nombres]{Rios, Dolores@Ríos, Dolores} & \texttlf{6000} & \textlf{6} & \texttlf{12} & \texttlf{4320} & Casa \\
J. A. Villegas Contreras & Fco. Calderón y Dolores Ríos & \texttlf{7000} & \textlf{7} & \texttlf{12}
& \texttlf{5880} & Casa \\
J. A. Villegas Contreras & Victorino\index[nombres]{Bando, Victorino} y Leonardo Bando\index[nombres]{Bando, Leonardo} & \texttlf{3000} & \textlf{3} & \texttlf{12} & \texttlf{1080} & Pahuatatempa\index[lugares]{Pahuatatempa!hacienda} y anexos Xaltepec\index[lugares]{Xaltepec!rancho} y Tachitepec\index[lugares]{Tachitepec!rancho} \\
J. A. Villegas Contreras & Victorino y Leonardo Bando & \texttlf{2550} & \textlf{5} & \texttlf{10} & \texttlf{1275} & Pahuatatempa y anexos Xaltepec y Tachitepec \\
...
Q. Villegas Contreras & Gertrudis Fernández\index[nombres]{Fernandez de Vinals, Gertrudis@Fernández de Viñals, Gertrudis} & \texttlf{17000} & \textlf{3} & \texttlf{12} & \texttlf{6120} & Casa \\
José María Villegas\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & M\textsu{a} N. Mendoza\index[nombres]{Mendoza, Maria Natividad@Mendoza, María Natividad} y Clotilde Ayala\index[nombres]{Ayala, Clotilde} & \texttlf{2000} & \textlf{2} & \texttlf{12} & \texttlf{720} & Casa \\
...
J. A. Villegas Contreras & Fco. Hernández\index[nombres]{Hernandez, Francisco@Hernández, Francisco} & \texttlf{30000} & \textlf{3} & \texttlf{6} & \texttlf{5400} & Hda. de Cuautotolapam\index[lugares]{Cuautotolapam!hacienda} \\
J. A. Villegas Contreras & José Gandara\index[nombres]{Gandara, Jose@Gandara, José} & \texttlf{2000} & \textlf{2} & \texttlf{6} & \texttlf{240} & Casas y terrenos \\
J. A. Villegas Contreras & Miguel Locela\index[nombres]{Locela, Miguel} & \texttlf{1000} & \textlf{4} & \texttlf{6} & \texttlf{240} & Casa y terrenos \\
J. A. Villegas Contreras & Santiago Flores\index[nombres]{Flores, Santiago} & \texttlf{350} & \textlf{3} & \texttlf{1} & \texttlf{10} & Casa \\
...
J. Villegas del Campo & Bacilio Bello\index[nombres]{Bello, Bacilio} & \texttlf{1147} & \textlf{2} & {} & {} & Rancho \\
J. Villegas del Campo & Manuel de Alcalde & \texttlf{773} & \textlf{1.5} & \texttlf{24} & \texttlf{241} & Rancho y terrenos \\
Josefa Villegas Contreras\index[nombres]{Villegas Contreras, Josefa} & Feliciano Mendoza\index[nombres]{Mendoza, Feliciano} & \texttlf{230} & \textlf{2} & {} & {} & Rancho \\
...
Q. Villegas Contreras & Miguel María de Guzmán & \texttlf{3500} & \textlf{2} & {} & {} & Casa \\
J. A. Villegas Contreras & Ignacio Bustos\index[nombres]{Bustos, Ignacio} & \texttlf{1522} & \textlf{1} & \texttlf{12} & \texttlf{182} & Fincas \\
J. A. Villegas Contreras & Juan del Campo\index[nombres]{Campo, Juan del} e hijos & \texttlf{2733} & \textlf{2} & \texttlf{6} & \texttlf{164} & Casa \\
J. Villegas del Campo & Bacilio Bello e hijos & \texttlf{1500} & \textlf{6} & {} & {} & Rancho \\
...
J. A. Villegas Contreras & Alejandro Marín & \texttlf{1600} & \textlf{1} & \texttlf{12} & \texttlf{192} & Rancho «Arroyo Zarco» \\
J. A. Villegas Contreras & Miguel Valdés & \texttlf{1034} & {} & \texttlf{12} & \texttlf{31} & Rancho, terreno y casa \\
M. L. Villegas Perdomo & Aniceto González\index[nombres]{Gonzalez, Aniceto@González, Aniceto} & \texttlf{140} & \textlf{1} & {} & {} & Rancho \\
...
J. A. Villegas Contreras & Miguel María de Guzmán & \texttlf{2000} & \textlf{0.25} & \texttlf{12} & \texttlf{60} & Casa \\
...
J. A. Villegas Contreras & Adolfo B. Carsi\index[nombres]{Carsi, Adolfo B.} & \texttlf{25000} & \textlf{5} & \texttlf{12} & \texttlf{15000} & Hda. «El Pital»\index[lugares]{Pital, El!hacienda} \\
J. A. Villegas Contreras & Juan\index[nombres]{Garcia, Juan@García, Juan} y José Antonio García\index[nombres]{Garcia, Jose Antonio@García, José Antonio} & \texttlf{5725} & \textlf{0.25} & \texttlf{12} & \texttlf{50} & Terrenos y casa \\
M. L. Villegas Perdomo & Marcos Mendoza\index[nombres]{Mendoza, Marcos} y esposa & \texttlf{199} & \textlf{1} & {} & {} & Terrenos \\
M. L. Villegas Perdomo & Miguel Juárez\index[nombres]{Juarez, Miguel@Juárez, Miguel} & \texttlf{76} & {} & {} & {} & Terrenos \\
J. A. Villegas Contreras & Luciano\index[nombres]{Hernandez, Luciano@Hernández, Luciano} y Gabriel E. Hernández\index[nombres]{Hernandez, Gabriel E.@Hernández, Gabriel E.} & \texttlf{6000} & \textlf{0.5} & \texttlf{12} & \texttlf{360} & Rancho «Santa Ana Moluapan»\index[lugares]{Santa Ana Moloapan!rancho} \\
M. L. Villegas Perdomo & Josefa Serrano\index[nombres]{Serrano, Josefa} & \texttlf{141} & \textlf{1} & {} & {} & Terrenos y casas \\
J. M. Villegas del Campo & Manuela Gómez de la Torre\index[nombres]{Gomez de la Torre, Manuela@Gómez de la Torre, Manuela} & \texttlf{3000} & \textlf{0.5} & \texttlf{12} & \texttlf{180} & Hda. Santa Cruz\index[lugares]{Santa Cruz!hacienda} y rancho San Luis\index[lugares]{San Luis!rancho} \\
J. A. Villegas Contreras & Luis Marín\index[nombres]{Marin, Luis@Marín, Luis} & \texttlf{9000} & \textlf{0.5} & \texttlf{12} & \texttlf{540} & Casas, terrenos, etc. \\
Miguel Villegas\index[nombres]{Villegas, Miguel} & Pascual Mendoza\index[nombres]{Mendoza, Pascual} & \texttlf{200} & \textlf{0.5} & {} & {} & Rancho \\
J. A. Villegas Contreras & M\textsu{a} de Jesús Carrión\index[nombres]{Carrion, Maria de Jesus@Carrión, María de Jesús} y Nicolás Soto\index[nombres]{Soto, Nicolas@Soto, Nicolás} & \texttlf{500} & \textlf{1} & {} & {} & Casa \\
...
J. A. Villegas Contreras & Ignacio Perdomo\index[nombres]{Perdomo, Ignacio} & \texttlf{4000} & \textlf{1} & \texttlf{6} & \texttlf{240} & Casa \\
J. A. Villegas Contreras & Felipe Revuelta\index[nombres]{Revuelta, Felipe} & \texttlf{4000} & \textlf{1} & \texttlf{9} & \texttlf{360} & Casa y terrenos \\
J. A. Villegas Contreras & Felipe Revuelta & \texttlf{3000} & \textlf{0.5} & \texttlf{9} & \texttlf{135} & Casa y terrenos \\
J. A. Villegas Contreras & Luciano y Gabriel E. Hernández & \texttlf{13000} & \textlf{1} & \texttlf{9} & \texttlf{1170} & Hda. «Santa Ana Moluapan» y «El Mirador»\index[lugares]{Mirador, El!rancho} \\
J. A. Villegas Contreras & Joaquín Hoyos\index[nombres]{Hoyos, Joaquin@Hoyos, Joaquín} y Dolores Vázquez\index[nombres]{Vazquez, Dolores@Vázquez, Dolores} & \texttlf{3000} & \textlf{0.5} & {} & {} & Rancho «Teacal»\index[lugares]{Teacal!rancho} \\
J. A. Villegas Contreras & Ana Rugama de Cruz\index[nombres]{Rugama de Cruz, Ana} y Carlos Cruz Rugama\index[nombres]{Cruz Rugama, Carlos} & \texttlf{53000} & \textlf{10} & \texttlf{6} & \texttlf{31800} & Hda. Tenextepec\index[lugares]{Tenextepec!hacienda} y anexos; casa en Puebla \\
J. A. Villegas Contreras & Luis Marín & \texttlf{15000} & \textlf{1} & \texttlf{6} & \texttlf{900} & Terrenos «Planes de Almanza»\index[lugares]{Almanza!Planes de} \\
J. A. Villegas Contreras & Benjamín González\index[nombres]{Gonzalez, Benjamin@González, Benjamín} y esposa & \texttlf{26185} & \textlf{4} & \texttlf{6} & \texttlf{6284} & Casas y terrenos \\
J. M. Villegas del Campo & Andrés Rodríguez\index[nombres]{Rodriguez, Andres@Rodríguez, Andrés} & \texttlf{600} & \textlf{1} & \texttlf{18} & \texttlf{108} & Terrenos \\
J. M. Villegas del Campo & Benigno Ríos\index[nombres]{Rios, Benigno@Ríos, Benigno} & \texttlf{6000} & \textlf{5} & \texttlf{12} & \texttlf{3600} & Hda. «Santa Cruz y anexos» \\
J. M. Villegas del Campo & Miguel Locela herederos\index[nombres]{Locela, Miguel!herederos} & \texttlf{1400} & \textlf{2} & \texttlf{12} & \texttlf{336} & Casa \\
J. M. Villegas del Campo & Roberto Guzmán\index[nombres]{Guzman, Roberto@Guzmán, Roberto} & \texttlf{5000} & \textlf{4} & \texttlf{12} & \texttlf{2400} & Rancho «Progreso»\index[lugares]{Progreso, El!rancho} y anexos; cafetales \\
J. M. Villegas del Campo & Luis Condado Velis\index[nombres]{Condado Velis, Luis} & \texttlf{2000} & {} & {} & {} & Terrenos \\
J. A. Villegas Contreras & José Gandara & \texttlf{2670} & \textlf{2} & \texttlf{6} & \texttlf{320} & Terrenos \\
...
J. A. Villegas Contreras & Enrique Mendoza\index[nombres]{Mendoza, Enrique} & \texttlf{3000} & \textlf{3} & \texttlf{6} & \texttlf{540} & Casa \\
J. A. Villegas Contreras & Fam. Flores\index[nombres]{Flores!familia} y Rosendo R. Velázquez\index[nombres]{Velazquez, Rosendo@Velázquez, Rosendo} & \texttlf{20000} & \textlf{6} & \texttlf{6} & \texttlf{7200} & Casas y terrenos \\
J. M. Villegas del Campo & Mariano Rivera\index[nombres]{Rivera, Mariano} & \texttlf{2000} & \textlf{3} & \texttlf{12} & \texttlf{720} & Terrenos y casas \\
J. M. Villegas del Campo & Antonio Murrieta Morales\index[nombres]{Murrieta Morales, Antonio} & \texttlf{2815} & \textlf{4} & \texttlf{12} & \texttlf{1351} & Terrenos y casas \\
J. M. Villegas del Campo & José Antonio García & \texttlf{650} & \textlf{2} & \texttlf{12} & \texttlf{156} & Terrenos y casas \\
J. M. Villegas del Campo & Fco. García González\index[nombres]{Garcia Gonzalez, Francisco@García González, Francisco} & \texttlf{350} & \textlf{2} & \texttlf{24} & \texttlf{168} & Terrenos \\
Guadalupe Villegas del Campo\index[nombres]{Villegas del Campo, Guadalupe} & Juan Cuevas & \texttlf{1200} & \textlf{3} & {} & {} & Terrenos \\
J. M. Villegas del Campo & Cosme Benavides\index[nombres]{Benavides, Cosme} & \texttlf{1000} & \textlf{2} & \texttlf{15} & \texttlf{300} & Rancho \\
...
J. M. Villegas del Campo & José Antonio García & \texttlf{4400} & \textlf{5} & \texttlf{12} & \texttlf{2640} & Rancho «Nansolco»\index[lugares]{Nansolco!rancho} \\
J. M. Villegas del Campo & María de Jesús Mendoza\index[nombres]{Mendoza, Maria de Jesus@Mendoza, María de Jesús} & \texttlf{4300} & \textlf{4} & \texttlf{10} & \texttlf{1720} & Casa \\
J. M. Villegas del Campo & Fam. Parra Mendoza\index[nombres]{Parra Mendoza!familia} & \texttlf{10000} & \textlf{3} & \texttlf{10} & \texttlf{3000} & Rancho «Tepantepec»\index[lugares]{Tepantepec!rancho} y casa \\
J. M. Villegas del Campo & S. Mota,\index[nombres]{Mota, Santiago} Manuel L. Glez.\index[nombres]{Gonzalez, Manuel L.@González, Manuel L.} y Porfirio Aburto\index[nombres]{Aburto, Porfirio} & \texttlf{4985} & \textlf{3} & \texttlf{9} & \texttlf{1346} & Casas \\
J. M. Villegas del Campo & Estanislao Galván Monfil\index[nombres]{Galvan Monfil, Estanislao@Galván Monfil, Estanislao} & \texttlf{9000} & \textlf{2} & {} & {} & Rancho «Progreso» \\
...
J. M. Villegas del Campo & Manuel L. González & \texttlf{1000} & \textlf{3} & \texttlf{9} & \texttlf{270} & Casa \\
J. M. Villegas del Campo\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & Santiago Mota\index[nombres]{Mota, Santiago} & \texttlf{4108} & \textlf{3} & \texttlf{6} & \texttlf{739} & Casa y terreno \\
L. Villegas Perdomo\index[nombres]{Villegas Perdomo, Leonardo} & J. M. Villegas Contreras & \texttlf{577} & {} & {} & {} & Terrenos \\
J. A. Villegas Sucs.\index[nombres]{Villegas Contreras, Jose Antonio@Villegas Contreras, José Antonio!sucesores} & José María Murrieta\index[nombres]{Murrieta, Jose Maria@Murrieta, José María} & \texttlf{11964} & \textlf{8} & \texttlf{6} & \texttlf{5742} & Terrenos \\
...
\bottomrule
\caption[Préstamos y rendimientos ideales obtenidos por la familia Villegas, 1872-1910]{Préstamos y rendimientos ideales obtenidos por la familia Villegas,\index[nombres]{Villegas!préstamos (\emph{cuadro})} 1872-1910. \textsc{Fuente:} \textsc{agnep}, 1876-1910; \textsc{arppj}, 1872-1910. \hspace{0.5em}\textsu{\em a}~\textsc{p} $=$ préstamo \hspace{0.5em}\textsu{\em b} \textsc{t} $=$ tiempo (en años) \hspace{0.5em}\textsc{tia}~$=$ tasa de interés anual \hspace{0.5em}\textsu{\em c} \textsc{r} $=$ rendimiento}
...
\bottomrule
\end{tabular}
\caption[Préstamos diferenciados, 1872-1910]{Préstamos diferenciados,\index[nombres]{Villegas!préstamos diferenciados (\emph{cuadro})} 1872-1910. \textsc{Fuente:} \textsc{agnep}, 1876-1910; \textsc{arppj}, 1872~-1910. \textsu{*} Compras o ventas con pacto de retroventa.}
...
\bottomrule
\end{tabular}
\caption[Préstamos realizados según la tasa de interés, 1872-1910]{Préstamos realizados según la tasa de interés, 1872-1910.\index[nombres]{Villegas!préstamos según tasa de interés (\emph{cuadro}} \textsc{Fuente:} \textsc{agnep}, 1876~-1910; \textsc{arppj}, 1872-1910. \textsu{*} \textsc{tia} $=$ tasa de interés anual.}
...
\emph{et al., Veracruz, un tiempo para contar. Memoria del 1"er Seminario de Historia Regional.} Universidad Veracruzana/Instituto Nacional de Antropología e Historia, México, 1989, 295 pp [Regiones de México].
...
\noindent\textcopyright\ 2022-2023 Creative Commons (pág. \pageref{fig:cc-srr})

\noindent\textcopyright\ 2022-2023 Creative Commons (pág. \pageref{fig:cc}) \\
