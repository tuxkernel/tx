...
\pagestyle{empty}
\phantomsection
\addcontentsline{toc}{chapter}{Licencia \emph{Creative Commons}}
\addtocontents{toc}{\vspace{\normalbaselineskip}} % Add some vertical space between titles in TOC
\vspace*{0pt}
\vfill
\begin{scriptsize}
...
\includegraphics[width=2.5cm]{fc}\phantomsection\label{fig:free-cultural} \protect\medskip

\includegraphics[width=2.5cm]{cc}\phantomsection\label{fig:cc-large} \protect\medskip

\includegraphics[width=2.5cm]{cc-large}\phantomsection\label{fig:cc} \protect\medskip

\def\fileversion{1.036}
\def\filedate{(27-10-2023)}
...
\lettrine[lines=3]{L}{a} paternidad de este trabajo no es exclusivamente mía. Fueron demasiadas las personas que contribuyeron en su nacimiento que un recuento de ellos me obligaría a escribir un texto gordo, casi con las mismas características de éste. Tampoco estableceré grados de apoyo pues cada uno contribuyó según sus tiempos y dedicación.
...
\pdfbookmark{Índice de contenidos}{Contenidos}
\thispagestyle{empty}
\pagestyle{fancy}
...
\caption[El cantón de Jalacingo a principios del siglo \textsc{xx}]{El cantón de Jalacingo\index[lugares]{Jalacingo!Mapa@\textit{Mapa}} a principios del siglo \textsc{xx}. \textsc{Fuente:} Luc Cambrezy y Bernal Lascurain, \emph{De la hacienda al ejido. Crónicas de un territorio fraccionado (Centro de Veracruz).} \textsc{larousse"/orstom}"/Centro de Estudios Mexicanos y Centroamericanos, México, 1992, p. 9.}
...
\bottomrule
\end{tabular}
\caption[Distribución poblacional del cantón de Jalacingo por municipio, 1869-1870 y 1873]{Distribución poblacional del cantón de Jalacingo\index[lugares]{Jalacingo!población (\emph{cuadro})} por municipio (habitantes), 1869-1870 y 1873. \textsu{*} \emph{véase} Cuadro~\ref{tab:poblacion-anos}, p.~\pageref{tab:poblacion-anos}. \textsc{Fuente:} Blázquez, \emph{op. cit.}, 1986a, t. \textsc{ii}, pp. 701 y 845; t. \textsc{iii}, p. 1724.}
...
\bottomrule
\end{tabular}
\caption[Venta de terrenos baldíos en Atzalan]{Venta de terrenos baldíos en Atzalan.\index[lugares]{Atzalan!terrenos baldíos (\emph{cuadro})} \textsc{Fuente:} \textsc{agev, asgg, gyj}, Tierras, Atzalan, 1886, fs. 34-36. \textsu{*} 1 estajo = 7 ha. Al respecto véase \textsc{agev, acam}, Atzalan, Atzalan, Dotación, 1937, fs. 53-58. \textsc{agev, acam}, Atzalan, San Felipe, Restitución, 1923, c. 233, exp. 444, fs. 60-61.}
...
\bottomrule
\end{tabular}
\caption[Productores de cerveza en Jalacingo, 1892-1894]{Productores de cerveza en Jalacingo,\index[lugares]{Jalacingo!cerveza} 1892-1894. Estilo de cerveza: corriente. \textsc{Fuente:} Blázquez, \emph{Estado...}, t. \textsc{ii}, s/f.; t. \textsc{viii}, p. 14.}
...
\bottomrule
\end{tabular}
\caption[Establecimientos industriales en Jalacingo]{Establecimientos industriales en Jalacingo.\index[lugares]{Jalacingo!industria} \textsc{Fuente:} Blázquez, \emph{Estado...}, t. \textsc{ii}, s/f.; t. \textsc{viii}, p. 14.}
...
\bottomrule
\end{tabular}
\caption[Jefes políticos del cantón de Jalacingo, 1873-1910]{Jefes políticos del cantón de Jalacingo,\index[lugares]{Jalacingo!jefes políticos (\emph{cuadro})} 1873-1910. \textsc{Fuente:} \textsc{arppj}, 1873-1910.}
...
\end{axis}
\end{tikzpicture}
\caption[Operaciones de la familia Villegas, 1872-1910]{Operaciones de la familia Villegas,\index[nombres]{Villegas!operaciones comerciales (\emph{gráfico})} 1872-1910. \textsc{Fuente:} \textsc{agnep}, 1876-1910. \textsc{arppj}, 1872-1910.}
...
\end{tikzpicture}
\caption[Operaciones de la familia Villegas, 1872-1910 (Porcentajes)]{Operaciones de la familia Villegas,\index[nombres]{Villegas!operaciones comerciales (\emph{gráfico})} 1872-1910 (Porcentajes). \textsc{Fuente:} \textsc{agnep}, 1876-1910. \textsc{arppj}, 1872-1910.}
...
\toprule
Acreedor & Deudor(es) & \textsc{p} (\$)\textsu{\emph{a}} & \textsc{t}\textsu{\em b} & \textsc{tia}\textsu{\em c} & \textsc{r} (\$)\textsu{\em d} & Garantía \\
\midrule
\endhead
\bottomrule
% Pie de la tabla
...
Acreedor & Deudor(es) & \textsc{p} (\$)\textsu{\emph{a}} & \textsc{t}\textsu{\em b} & \textsc{tia}\textsu{\em c} & \textsc{r} (\$)\textsu{\em d} & Garantía \\
\midrule
J. A. Villegas Contreras\index[nombres]{Villegas Contreras, Jose Antonio@Villegas Contreras, José Antonio} & Ignacio Danini\index[nombres]{Danini, Ignacio} e Isidoro O. Marié\index[nombres]{Marie, Isidoro O.@Marié, Isidoro O.} & \texttlf{20000} & \texttlf{8} & \texttlf{12} & \texttlf{19200} & Hda. San Miguel del Rincón\index[lugares]{San Miguel del Rincon@San Miguel del Rincón!hacienda} \\
J. A. Villegas Contreras & Ignacio Danini e Isidoro o. Marié & \texttlf{10000} & \texttlf{3} & \texttlf{12} & \texttlf{3600} & Hda. San Miguel del Rincón \\
J. A. Villegas Contreras & Miguel Valdés\index[nombres]{Valdes, Miguel@Valdés, Miguel} & \texttlf{4000} & \texttlf{3} & \texttlf{12} & \texttlf{1440} & Rancho Buenavista\index[lugares]{San Pedro Buenavista!rancho} \\
J. A. Villegas Contreras & Nicolás Velázquez\index[nombres]{Velazquez, Nicolas@Velázquez, Nicolás} & \texttlf{3000} & \texttlf{3} & \texttlf{12} & \texttlf{1080} & Casa \\
...
J. A. Villegas Contreras & José Huici\index[nombres]{Huici, Jose@Huici, José} y Cástula Naveda\index[nombres]{Naveda, Castula@Naveda, Cástula} & \texttlf{1000} & \texttlf{2} & \texttlf{12} & \texttlf{240} & Casa \\
J. A. Villegas Contreras & Manuel\index[nombres]{Lopez Leon, Manuel@López León, Manuel} y Herminia López León\index[nombres]{Lopez Leon, Herminia@López León, Herminia} & \texttlf{7000} & \texttlf{3} & \texttlf{12} & \texttlf{2520} & Casa y terreno \\
J. A. Villegas Contreras & Fco. Calderón\index[nombres]{Calderon, Francisco@Calderón, Francisco} y Dolores Ríos\index[nombres]{Rios, Dolores@Ríos, Dolores} & \texttlf{6000} & \texttlf{6} & \texttlf{12} & \texttlf{4320} & Casa \\
J. A. Villegas Contreras & Fco. Calderón y Dolores Ríos & \texttlf{7000} & \texttlf{7} & \texttlf{12}
& \texttlf{5880} & Casa \\
J. A. Villegas Contreras & Victorino\index[nombres]{Bando, Victorino} y Leonardo Bando\index[nombres]{Bando, Leonardo} & \texttlf{3000} & \texttlf{3} & \texttlf{12} & \texttlf{1080} & Pahuatatempa\index[lugares]{Pahuatatempa!hacienda} y anexos Xaltepec\index[lugares]{Xaltepec!rancho} y Tachitepec\index[lugares]{Tachitepec!rancho} \\
...
Q. Villegas Contreras & Gertrudis Fernández\index[nombres]{Fernandez de Vinals, Gertrudis@Fernández de Viñals, Gertrudis} & \texttlf{17000} & \texttlf{3} & \texttlf{12} & \texttlf{6120} & Casa \\
José María Villegas\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & M\textsu{a} N. Mendoza\index[nombres]{Mendoza, Maria Natividad@Mendoza, María Natividad} y Clotilde Ayala\index[nombres]{Ayala, Clotilde} & \texttlf{2000} & \texttlf{2} & \texttlf{12} & \texttlf{720} & Casa \\
...
J. A. Villegas Contreras & Fco. Hernández\index[nombres]{Hernandez, Francisco@Hernández, Francisco} & \texttlf{30000} & \texttlf{3} & \texttlf{6} & \texttlf{5400} & Hda. de Cuautotolapam\index[lugares]{Cuautotolapam!hacienda} \\
J. A. Villegas Contreras & José Gandara\index[nombres]{Gandara, Jose@Gandara, José} & \texttlf{2000} & \texttlf{2} & \texttlf{6} & \texttlf{240} & Casas y terrenos \\
J. A. Villegas Contreras & Miguel Locela\index[nombres]{Locela, Miguel} & \texttlf{1000} & \texttlf{4} & \texttlf{6} & \texttlf{240} & Casa y terrenos \\
J. A. Villegas Contreras & Santiago Flores\index[nombres]{Flores, Santiago} & \texttlf{350} & \texttlf{3} & \texttlf{1} & \texttlf{10} & Casa \\
...
J. Villegas del Campo & Bacilio Bello\index[nombres]{Bello, Bacilio} & \texttlf{1147} & \texttlf{2} & {} & {} & Rancho \\
J. Villegas del Campo & Manuel de Alcalde & \texttlf{773} & \texttlf{1.5} & \texttlf{24} & \texttlf{241} & Rancho y terrenos \\
Josefa Villegas Contreras\index[nombres]{Villegas Contreras, Josefa} & Feliciano Mendoza\index[nombres]{Mendoza, Feliciano} & \texttlf{230} & \texttlf{2} & {} & {} & Rancho \\
...
J. A. Villegas Contreras & Ignacio Bustos\index[nombres]{Bustos, Ignacio} & \texttlf{1522} & \texttlf{1} & \texttlf{12} & \texttlf{182} & Fincas \\
J. A. Villegas Contreras & Juan del Campo\index[nombres]{Campo, Juan del} e hijos & \texttlf{2733} & \texttlf{2} & \texttlf{6} & \texttlf{164} & Casa \\
...
M. L. Villegas Perdomo & Aniceto González\index[nombres]{Gonzalez, Aniceto@González, Aniceto} & \texttlf{140} & \texttlf{1} & {} & {} & Rancho \\
...
J. A. Villegas Contreras & Adolfo B. Carsi\index[nombres]{Carsi, Adolfo B.} & \texttlf{25000} & \texttlf{5} & \texttlf{12} & \texttlf{15000} & Hda. «El Pital»\index[lugares]{Pital, El!hacienda} \\
J. A. Villegas Contreras & Juan\index[nombres]{Garcia, Juan@García, Juan} y José Antonio García\index[nombres]{Garcia, Jose Antonio@García, José Antonio} & \texttlf{5725} & \texttlf{0.25} & \texttlf{12} & \texttlf{50} & Terrenos y casa \\
M. L. Villegas Perdomo & Marcos Mendoza\index[nombres]{Mendoza, Marcos} y esposa & \texttlf{199} & \texttlf{1} & {} & {} & Terrenos \\
M. L. Villegas Perdomo & Miguel Juárez\index[nombres]{Juarez, Miguel@Juárez, Miguel} & \texttlf{76} & {} & {} & {} & Terrenos \\
J. A. Villegas Contreras & Luciano\index[nombres]{Hernandez, Luciano@Hernández, Luciano} y Gabriel E. Hernández\index[nombres]{Hernandez, Gabriel E.@Hernández, Gabriel E.} & \texttlf{6000} & \texttlf{0.5} & \texttlf{12} & \texttlf{360} & Rancho «Santa Ana Moluapan»\index[lugares]{Santa Ana Moloapan!rancho} \\
M. L. Villegas Perdomo & Josefa Serrano\index[nombres]{Serrano, Josefa} & \texttlf{141} & \texttlf{1} & {} & {} & Terrenos y casas \\
J. M. Villegas del Campo & Manuela Gómez de la Torre\index[nombres]{Gomez de la Torre, Manuela@Gómez de la Torre, Manuela} & \texttlf{3000} & \texttlf{0.5} & \texttlf{12} & \texttlf{180} & Hda. Santa Cruz\index[lugares]{Santa Cruz!hacienda} y rancho San Luis\index[lugares]{San Luis!rancho} \\
J. A. Villegas Contreras & Luis Marín\index[nombres]{Marin, Luis@Marín, Luis} & \texttlf{9000} & \texttlf{0.5} & \texttlf{12} & \texttlf{540} & Casas, terrenos, etc. \\
Miguel Villegas\index[nombres]{Villegas, Miguel} & Pascual Mendoza\index[nombres]{Mendoza, Pascual} & \texttlf{200} & \texttlf{0.5} & {} & {} & Rancho \\
J. A. Villegas Contreras & M\textsu{a} de Jesús Carrión\index[nombres]{Carrion, Maria de Jesus@Carrión, María de Jesús} y Nicolás Soto\index[nombres]{Soto, Nicolas@Soto, Nicolás} & \texttlf{500} & \texttlf{1} & {} & {} & Casa \\
...
J. A. Villegas Contreras & Ignacio Perdomo\index[nombres]{Perdomo, Ignacio} & \texttlf{4000} & \texttlf{1} & \texttlf{6} & \texttlf{240} & Casa \\
J. A. Villegas Contreras & Felipe Revuelta\index[nombres]{Revuelta, Felipe} & \texttlf{4000} & \texttlf{1} & \texttlf{9} & \texttlf{360} & Casa y terrenos \\
J. A. Villegas Contreras & Felipe Revuelta & \texttlf{3000} & \texttlf{0.5} & \texttlf{9} & \texttlf{135} & Casa y terrenos \\
J. A. Villegas Contreras & Luciano y Gabriel E. Hernández & \texttlf{13000} & \texttlf{1} & \texttlf{9} & \texttlf{1170} & Hda. «Santa Ana Moluapan» y «El Mirador»\index[lugares]{Mirador, El!rancho} \\
J. A. Villegas Contreras & Joaquín Hoyos\index[nombres]{Hoyos, Joaquin@Hoyos, Joaquín} y Dolores Vázquez\index[nombres]{Vazquez, Dolores@Vázquez, Dolores} & \texttlf{3000} & \texttlf{0.5} & {} & {} & Rancho «Teacal»\index[lugares]{Teacal!rancho} \\
J. A. Villegas Contreras & Ana Rugama de Cruz\index[nombres]{Rugama de Cruz, Ana} y Carlos Cruz Rugama\index[nombres]{Cruz Rugama, Carlos} & \texttlf{53000} & \texttlf{10} & \texttlf{6} & \texttlf{31800} & Hda. Tenextepec\index[lugares]{Tenextepec!hacienda} y anexos; casa en Puebla \\
J. A. Villegas Contreras & Luis Marín & \texttlf{15000} & \texttlf{1} & \texttlf{6} & \texttlf{900} & Terrenos «Planes de Almanza»\index[lugares]{Almanza!Planes de} \\
J. A. Villegas Contreras & Benjamín González\index[nombres]{Gonzalez, Benjamin@González, Benjamín} y esposa & \texttlf{26185} & \texttlf{4} & \texttlf{6} & \texttlf{6284} & Casas y terrenos \\
J. M. Villegas del Campo & Andrés Rodríguez\index[nombres]{Rodriguez, Andres@Rodríguez, Andrés} & \texttlf{600} & \texttlf{1} & \texttlf{18} & \texttlf{108} & Terrenos \\
J. M. Villegas del Campo & Benigno Ríos\index[nombres]{Rios, Benigno@Ríos, Benigno} & \texttlf{6000} & \texttlf{5} & \texttlf{12} & \texttlf{3600} & Hda. «Santa Cruz y anexos» \\
J. M. Villegas del Campo & Miguel Locela herederos\index[nombres]{Locela, Miguel!herederos} & \texttlf{1400} & \texttlf{2} & \texttlf{12} & \texttlf{336} & Casa \\
J. M. Villegas del Campo & Roberto Guzmán\index[nombres]{Guzman, Roberto@Guzmán, Roberto} & \texttlf{5000} & \texttlf{4} & \texttlf{12} & \texttlf{2400} & Rancho «Progreso»\index[lugares]{Progreso, El!rancho} y anexos; cafetales \\
...
J. A. Villegas Contreras & Enrique Mendoza\index[nombres]{Mendoza, Enrique} & \texttlf{3000} & \texttlf{3} & \texttlf{6} & \texttlf{540} & Casa \\
J. A. Villegas Contreras & Fam. Flores\index[nombres]{Flores!familia} y Rosendo R. Velázquez\index[nombres]{Velazquez, Rosendo@Velázquez, Rosendo} & \texttlf{20000} & \texttlf{6} & \texttlf{6} & \texttlf{7200} & Casas y terrenos \\
J. M. Villegas del Campo & Mariano Rivera\index[nombres]{Rivera, Mariano} & \texttlf{2000} & \texttlf{3} & \texttlf{12} & \texttlf{720} & Terrenos y casas \\
J. M. Villegas del Campo & Antonio Murrieta Morales\index[nombres]{Murrieta Morales, Antonio} & \texttlf{2815} & \texttlf{4} & \texttlf{12} & \texttlf{1351} & Terrenos y casas \\
J. M. Villegas del Campo & José Antonio García & \texttlf{650} & \texttlf{2} & \texttlf{12} & \texttlf{156} & Terrenos y casas \\
J. M. Villegas del Campo & Fco. García González\index[nombres]{Garcia Gonzalez, Francisco@García González, Francisco} & \texttlf{350} & \texttlf{2} & \texttlf{24} & \texttlf{168} & Terrenos \\
Guadalupe Villegas del Campo\index[nombres]{Villegas del Campo, Guadalupe} & Juan Cuevas & \texttlf{1200} & \texttlf{3} & {} & {} & Terrenos \\
J. M. Villegas del Campo & Cosme Benavides\index[nombres]{Benavides, Cosme} & \texttlf{1000} & \texttlf{2} & \texttlf{15} & \texttlf{300} & Rancho \\
...
J. M. Villegas del Campo & José Antonio García & \texttlf{4400} & \texttlf{5} & \texttlf{12} & \texttlf{2640} & Rancho «Nansolco»\index[lugares]{Nansolco!rancho} \\
J. M. Villegas del Campo & María de Jesús Mendoza\index[nombres]{Mendoza, Maria de Jesus@Mendoza, María de Jesús} & \texttlf{4300} & \texttlf{4} & \texttlf{10} & \texttlf{1720} & Casa \\
J. M. Villegas del Campo & Fam. Parra Mendoza\index[nombres]{Parra Mendoza!familia} & \texttlf{10000} & \texttlf{3} & \texttlf{10} & \texttlf{3000} & Rancho «Tepantepec»\index[lugares]{Tepantepec!rancho} y casa \\
J. M. Villegas del Campo & S. Mota,\index[nombres]{Mota, Santiago} Manuel L. Glez.\index[nombres]{Gonzalez, Manuel L.@González, Manuel L.} y Porfirio Aburto\index[nombres]{Aburto, Porfirio} & \texttlf{4985} & \texttlf{3} & \texttlf{9} & \texttlf{1346} & Casas \\
J. M. Villegas del Campo & Estanislao Galván Monfil\index[nombres]{Galvan Monfil, Estanislao@Galván Monfil, Estanislao} & \texttlf{9000} & \texttlf{2} & {} & {} & Rancho «Progreso» \\
...
J. M. Villegas del Campo\index[nombres]{Villegas del Campo, Jose Maria@Villegas del Campo, José María} & Santiago Mota\index[nombres]{Mota, Santiago} & \texttlf{4108} & \texttlf{3} & \texttlf{6} & \texttlf{739} & Casa y terreno \\
L. Villegas Perdomo\index[nombres]{Villegas Perdomo, Leonardo} & J. M. Villegas Contreras & \texttlf{577} & {} & {} & {} & Terrenos \\
J. A. Villegas Sucs.\index[nombres]{Villegas Contreras, Jose Antonio@Villegas Contreras, José Antonio!sucesores} & José María Murrieta\index[nombres]{Murrieta, Jose Maria@Murrieta, José María} & \texttlf{11964} & \texttlf{8} & \texttlf{6} & \texttlf{5742} & Terrenos \\
...
\bottomrule
\caption[Préstamos y rendimientos ideales obtenidos por la familia Villegas, 1872-1910]{Préstamos y rendimientos ideales obtenidos por la familia Villegas,\index[nombres]{Villegas!préstamos (\emph{cuadro})} 1872-1910. \textsu{\em a}~\textsc{p} = préstamo; \textsu{\em b} \textsc{t} = tiempo (en años); \textsu{\em c} \textsc{tia} = tasa de interés anual (en \char 37); \textsu{\em d} \textsc{r}= rendimiento. \textsc{Fuente:} \textsc{agnep}, 1876-1910. \textsc{arppj}, 1872-1910.}
...
\bottomrule
\end{tabular}
\caption[Capitales totales, 1872-1910]{Capitales totales,\index[nombres]{Villegas!familia!capitales totales (\emph{cuadro})} 1872-1910. \textsc{Fuente:} \textsc{agnep}, 1876-1910. \textsc{arppj}, 1872-1910.}
...
\bottomrule
\end{tabular}
\caption[Operaciones de la familia Villegas, 1872-1910]{Operaciones de la familia Villegas,\index[nombres]{Villegas!operaciones comerciales (\emph{cuadro})} 1872-1910. \textsc{Fuente:} \textsc{agnep}, 1876-1910. \textsc{arppj}, 1872-1910.}
...
\bottomrule
\end{tabular}
\caption[Préstamos diferenciados, 1872-1910]{Préstamos diferenciados,\index[nombres]{Villegas!préstamos diferenciados (\emph{cuadro})} 1872-1910. \textsu{*} Compras o ventas con pacto de retroventa. \textsc{Fuente:} \textsc{agnep}, 1876-1910. \textsc{arppj}, 1872-1910.}
...
\bottomrule
\end{tabular}
\caption[Préstamos realizados según la tasa de interés, 1872-1910]{Préstamos realizados según la tasa de interés, 1872-1910.\index[nombres]{Villegas!préstamos según tasa de interés (\emph{cuadro}) } \textsu{*} \textsc{tia} = tasa de interés anual. \textsc{Fuente:} \textsc{agnep}, \mbox{1876-1910}. \textsc{arppj}, 1872-1910.}
...
\bottomrule
\end{tabular}
\caption[Préstamos realizados según la duración ideal contractual, \mbox{1872-1910}]{Préstamos realizados según la duración ideal contractual, \mbox{1872-1910}.\index[nombres]{Villegas!préstamos según duración (\emph{cuadro})} \textsc{Fuente:} \textsc{agnep}, 1876-1910. \textsc{arppj}, 1872-1910.}
...
\caption[Préstamos anuales de la familia Villegas, 1872-1905]{Prestamos anuales de la familia Villegas,\index[nombres]{Villegas!préstamos anuales (\emph{gráfico})} 1872-1905. \textsc{Fuente:} \textsc{agnep}, 1876-1910; \textsc{arppj, 1872-1910}.}
...
\bottomrule
\end{tabular}
\caption[Ranchos de la familia Villegas]{Ranchos de la familia Villegas.\index[nombres]{Villegas!ranchos (\emph{cuadro})} \textsc{Fuente:} \textsc{agnep} 1876-1910; \textsc{arppj}, 1872-1910.}
...
\fancyhf{} % Remueve los encabezados y pies previos. Necesario sí o sí.
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872-1910} % Centrados
\fancyhead[CO]{\small\sc apéndice d: aviso legal"/disclaimer} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
% Fix TeX, LaTeX and LaTeXe logos
%\def\TeX{T\kern-.1667em\lower.5ex\hbox{E}\kern-.125emX} % Knuth TeX logo definition
