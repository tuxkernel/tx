...
\begin{center}
\begin{minipage}{11cm}
\includegraphics[width=3cm]{01}\label{fig:buap} \hfill \includegraphics[width=2.8cm]{02}
\label{fig:icsyh}
\end{minipage}
\end{center}
\protect\smallskip
...
\newpage
\pagestyle{empty}
\pdfbookmark{Licencia Creative Commons}{licencia}
\vspace*{0pt}
\vfill
\begin{scriptsize}
\begin{flushleft}
\begin{minipage}{7.5cm}
\includegraphics[width=2.5cm]{fcw}\phantomsection\label{fig:free-cultural} \protect\medskip

\includegraphics[width=2.5cm]{cc-large}\phantomsection\label{fig:cc-large} \protect\medskip

\includegraphics[width=2.5cm]{cc}\phantomsection\label{fig:cc} \protect\medskip
...
\begin{sidewaysfigure}
\centering
\includegraphics[height=14.2cm]{cuautotolapam}
...
\vfill
\begin{center}
\pdfbookmark{Apéndices}{appendix}
