...
\usepackage{hologo} % For TeX, LaTeX and LaTeXe logos
...
\includegraphics[width=2.5cm]{cc-large}\phantomsection\label{fig:cc-large} \medskip

\includegraphics[width=2.5cm]{cc}\phantomsection\label{fig:cc} \medskip
...
\end{center}
\noindent que indica que estas citando la página 13 de la versión 2023, pero cuyo contenido está basado en la de 2007; solo adapta el ejemplo anterior a tu modelo de citación. Si te resulta «complicado» este método, usa la versión original (2007) y listo.
...
\hangpara{1cm}{1}\textsc{Bloch}, Marc, \emph{Introducción a la historia.} Fondo de Cultura Económica, México, 1987, 159 pp. \enlargethispage{\baselineskip}
...
\fancyhf{} % Remueve los encabezados y pies previos. Necesario sí o sí.
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872-1910} % Centrados
\fancyhead[CO]{\small\sc glosario} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\pagenumbering{arabic}
\setcounter{page}{137}
...
\fancyhf{} % Remueve los encabezados y pies previos. Necesario sí o sí.
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872-1910} % Centrados
\fancyhead[CO]{\small\sc aviso legal"/disclaimer} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\pagenumbering{arabic}
\setcounter{page}{139}
...
Crimson Text\texttrademark\ es una marca registrada de Sebastian Kosch, y la tipografía se distribuye bajo una licencia \textsc{sil} Open Font.

Cochineal\texttrademark\ es una marca registrada de Michael Sharpe, y la tipografía se distribuye bajo una licencia \textsc{sil} Open Font.
...
Inkscape es \emph{software}, y se distribuye bajo la licencia pública general de \textsc{gnu}, versión 3.
% INDICE ONOMÁSTICO
%\newpage
%\thispagestyle{plain}
%\pagestyle{fancy}
