...
\def\fileversion{1.045}
\def\filedate{(01-01-2024)}
...
{\par\sloppy\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{Veracruz. Una historia compartida.} Gobierno del estado de Veracruz/Instituto Veracruzano de Cultura/Instituto Mora, México, 1988a, tomo \textsc{i}, 369 pp.\par}% fix bad linebreak.
