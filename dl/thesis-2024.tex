...
\cmidrule{3-4}
Fábrica & Propietario & Aguardiente\textsu{1} & Panela\textsu{2} & {} \\
\midrule
...
\fancyhf{} % Remueve los encabezados y pies previos. Necesario sí o sí.
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872--1910} % Centrados
\fancyhead[CO]{\small\sc apéndice c: aviso legal} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
...
\begin{center}
\textls[50]{DO WHAT THE FUCK YOU WANT TO PUBLIC LICENSE} \\ Version 2, December 2004
\end{center}
...
\begin{center}
\textls[50]{DO WHAT THE FUCK YOU WANT TO PUBLIC LICENSE \\ TERMS AND CONDITIONS FOR COPYING, DISTRIBUTION AND MODIFICATION}
\end{center}
0. You just \textls[50]{DO WHAT THE FUCK YOU WANT TO.}
% INDICE ONOMÁSTICO
\newpage
\thispagestyle{empty}
\pagestyle{fancy}
