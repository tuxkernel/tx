...
\pagestyle{empty}
\protect\phantomsection
\addcontentsline{toc}{chapter}{Licencia WTFPL}
\addtocontents{toc}{\vspace{\normalbaselineskip}} % Add some vertical space between titles in TOC
\vspace*{0pt}
\vfill
\begin{scriptsize}
...
Este documento se proporciona \emph{como es,} sin ningún tipo de garantía, aunque se espera que pueda ser útil, y se distribuye bajo una licencia \href{http://www.wtfpl.net/}{Do What The Fuck You Want To Public License (\lsc{WTFPL})}, versión 2.0 o posterior. Por lo tanto, eres libre de hacer con este material lo que te dé la \xout{puta} gana. \protect\medskip
