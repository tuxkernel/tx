...
\end{center}
\noindent Lo anterior indica que estas citando la página 13 de la versión 2024, pero cuyo contenido está basado en la de 2007; solo adapta el ejemplo anterior a tu modelo de citación. Si te resulta «compleja» esta nueva modalidad para citar, usa la versión «original» (2007) y punto.
...
\end{flushright}
\bigskip
A \textls[50]{RMS} (\textsc{gnu}), \textls[50]{LT} (Linux) y \textls[50]{IM},\textsuperscript{\fontencoding{TS1}\selectfont\char100} (Debian). A \textls[50]{KB} (TeX Live) y a \textls[50]{PB} (TeXmaker).

A \textls[50]{DEK} (TeX), \textls[50]{LL} (LaTeX) y \textls[50]{HTT} (\textsc{pdf}TeX); sin su trabajo, esta «nueva» \emph{composición} simplemente no existiría.

A los TeX \emph{h4ck3rs} que existen \emph{out there,} especialmente a \textls[50]{FM}, \textls[50]{RF},\textsuperscript{\fontencoding{TS1}\selectfont\char100} \textls[50]{SR},\textsuperscript{\fontencoding{TS1}\selectfont\char100} \textls[50]{WL}, \textls[50]{JBL}, \textls[50]{MS}, \textls[50]{DA}, \textls[50]{GN}, \textls[50]{WAS},\textsuperscript{\fontencoding{TS1}\selectfont\char100} \textls[50]{PW}, \textls[50]{HO}, \textls[50]{TT}, \textls[50]{EG}, \textls[50]{PL}, \textls[50]{JW}, \textls[50]{RS}, \textls[50]{CLS}, \textls[50]{HU}, \textls[50]{RN}, \textls[50]{SIB}, \textls[50]{PVO}, \textls[50]{KW}, \textls[50]{DC}, \textls[50]{TT}, \textls[50]{UK}, \textls[50]{CF}, \textls[50]{YX}, \textls[50]{PI}, \textls[50]{TFS}, \textls[50]{SF}, \textls[50]{ØB}, \textls[50]{JL}, \textls[50]{LB}, \textls[50]{AL}, \textls[50]{AS}, \textls[50]{AB}, \textls[50]{MU} y \textls[50]{SP}.

Y desde luego a todos aquellos que en \url{https://tex.stackexchange.com/} proporcionaron código, sugerencias y comentarios, para que este trabajo fuera mejor.
\bigskip
\begin{flushright}
Tuxkernel, \\ Ciberespacio, julio del 2022.
\end{flushright}
\cleardoublepage
% CONTENIDO
\makeatletter
...
Frente a los exiguos logros en cuanto al reparto de los terrenos comunales, la venta de terrenos baldíos\index[lugares]{Jalacingo!terrenos baldíos} tuvo mejores resultados (\emph{v.} Cuadro~\ref{tab:venta-terrenos-baldios}, pág.~\pageref{tab:venta-terrenos-baldios}). Tan sólo en el municipio de Atzalan\index[lugares]{Atzalan!terrenos baldíos} fueron repartidas, en diferentes fechas, al menos 171\,273 ha\linelabel{cuatro} a diferentes individuos nacionales y extranjeros, lo que vendría a acentuar el aumento de las grandes propiedades durante el Porfiriato.\footnote{Se repartieron más terrenos baldíos pero las autoridades no las consignaron por tratarse de pequeñas propiedades.} Hubo una disparidad en la adjudicación de los baldíos. Las 658~ha\linelabel{siete} que se adjudicaron a José Cazzasa (sic),\index[nombres]{Cazzasa, Jose@Cazzasa, José} eran mínimas en comparación con las 62\,811 ha\linelabel{ocho} que se le otorgaron a Roberto Guzmán,\index[nombres]{Guzman, Roberto@Guzmán, Roberto} un próspero comerciante, reconocido usurero y miembro de la élite local del poblado de Atzalan.\index[lugares]{Atzalan!poblado} Aparte de las dimensiones superficiales de los baldíos,\index[lugares]{Atzalan!terrenos baldíos} debe tenerse en cuenta su riqueza agropecuaria. Se trataba de terrenos ubicados en la zona caliente del cantón,\index[lugares]{Jalacingo!cantón} con abundante agua, aptos para el cultivo de la vainilla, el tabaco, el café, la caña de azúcar y la engorda de ganado mayor, productos con una fuerte demanda en el mercado nacional e internacional.
\end{linenumbers}
\begin{table}%[H]
\centering
...
\midrule
\pageref{para:errata}\textsu{*} & \texttlf{2} & \texttlf{\lineref{cuatro}} & \texttlf{171273}\,ha & \texttlf{17159}\,ha \\
\pageref{para:errata}\textsu{*} & \texttlf{2} & \texttlf{\lineref{siete}} & \texttlf{658}\,ha & \texttlf{65}\,ha \\
\pageref{para:errata}\textsu{*} & \texttlf{2} & \texttlf{\lineref{ocho}} & \texttlf{62811}\,ha & \texttlf{6299}\,ha \\
\bottomrule
\end{tabular}
