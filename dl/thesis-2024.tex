...
\end{flushright}
\vspace*{72pt}
A Richard M. Stallman, Linus Torvalds y Ian Murdock,\textsuperscript{\textdagger} por crear \textsc{gnu}, Linux y Debian, respectivamente.

A Karl Berry por TeX Live, y a Pascal Brachet por el editor de texto plano, TeXmaker.

A Donald E. Knuth, Leslie Lamport y Hàn Th\'{ê} Thành, por crear TeX, LaTeX y \textsc{pdf}TeX; sin su trabajo, esta \emph{composición} simplemente no existiría.

A toda la comunidad TeX que existe allá afuera, especialmente a Frank Mittelbach, Robin Fairbarns,\textsuperscript{\textdagger} Sebastian Rahtz,\textsuperscript{\textdagger} Werner Lemberg, Javier Bezos López, Michael Sharpe, Donald Arseneau, Gerd Neugebauer, Walter Schmidt,\textsuperscript{\textdagger} Peter Wilson, Heiko Oberdiek, Thomas Titz, Enrico Gregorio, Philipp Lehman, Joseph Wright, Robert Schlicht, Christoph L. Spiel, Hideo Umeki, Rolf Niepraschk, Stephan~I. Böttcher, Pieter van Oostrum, Karl Wette, David Carlisle, Till Tantau, Uwe Kern, Christian Feuersänger, Yuan Xu, Paul Isambert, Thomas F. Sturm, Simon Fear, Øystein Bache, Jerry Leichter, Leonor Barroca, Anselm Lingnau, Axel Sommerfeldt, Andreas Bühmann, Michael Ummels y Scott Pakin.

Y a todas aquellas personas que en \url{https://tex.stackexchange.com/} proporcionaron código, sugerencias y comentarios, para que este trabajo fuera mucho mejor.
\vspace*{24pt}
\begin{flushright}
...
Linux\texttrademark\ es una marca registrada de Linus Torvalds, y su \emph{software} se distribuye bajo la licencia pública general de \textsc{gnu}.
...
TeX Live\texttrademark\ es una marca registrada de Karl Berry, y su \emph{software} se distribuye bajo la licencia pública del proyecto LaTeX, versión 2.

TeXmaker\texttrademark\ es una marca registrada de Pascal Brachet, y su \emph{software} se distribuye bajo la licencia pública general de \textsc{gnu}.
