...
\newcommand{\open}[1]{\textcolor{blue}{[\lfstyle #1]}}
\newcommand{\close}[1]{\textcolor{blue}{[\lfstyle #1]}}
\begin{document}
...
\bottomrule
\end{tabular}
\caption[Haciendas del cantón de Jalacingo en 1907]{Haciendas del cantón de Jalacingo en 1907. \textsc{Fuente:} \textsc{Falcon y García}, 1986, p. 36-37. \textsc{García} en \textsc{Benítez} y \textsc{Blázquez}, 1989, p. 166 y 167. \textsu{*} maíz, trigo, cebada.}
...
\centering
\includegraphics[width=16.2cm]{06}
...
\begin{sidewaysfigure}
\centering
\includegraphics[width=16.4cm]{07}
...
\bottomrule
\end{tabular}
\caption[Haciendas de la familia Villegas]{Haciendas de la familia Villegas. \textsu{\em a} Papantla; \textsu{\em b} Libres, Pue.; \textsc{Fuente:} \textsc{arppj}, 1874-1905. \textsc{agnep}, 1881. \textsc{Southworth}. \textsc{Falcón y García}, 1986, pp. 36-37. \textsc{agev, acam}, Tierras, Jalacingo, Santa Anita, Dotación, Caja: 135, Expediente: 243, Año: 1922, Fojas: 1-2.}
...
\begin{sidewaysfigure}
\centering
\includegraphics[height=13.7cm]{limon}
...
\hangpara{1cm}{1}\textsc{Blázquez} Domínguez, Carmen (Comp.) \emph{Estado de Veracruz, Informes de sus gobernadores, 1826-1986}. Gobierno del Estado de Veracruz, Xalapa, 1986, Tomos \textsc{ii-ix}.

\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{Veracruz liberal, 1858-1860}. El Colegio de México"/Gobierno del Estado de Veracruz, México, 1986, 269 pp.

\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{Veracruz. Una historia compartida}. Gobierno del Estado de Veracruz"/Instituto Veracruzano de Cultura"/Instituto Mora, México, 1988, t. \textsc{i}, 369 pp.

\hangpara{1cm}{1}\rule{1cm}{0.4pt}, (Comp.) \emph{Veracruz. Textos de su historia}. Gobierno del Estado de Veracruz"/Instituto Veracruzano de Cultura"/Instituto Mora, México, 1988, t. \textsc{ii}, 419 pp.
...
\hangpara{1cm}{1}\textsc{Florescano}, Enrique. \emph{Breve historia de la sequía en México}. Consejo Nacional para la Cultura y las Artes (Regiones), México, 2000, 252 pp.
...
\hangpara{1cm}{1}\textsc{Fuentes}, Carlos. \emph{La muerte de Artemio Cruz}. DeAgostini"/Consejo Nacional para la Cultura y las Artes. (Grandes Novelas de la Historia Mexicana), México, 2003, 311 pp.

\hangpara{1cm}{1}\textsc{Galindo}, Sergio. \emph{Otilia Rauda}. Universidad Veracruzana (Ficción), Xalapa, 2001, 321 pp.

\hangpara{1cm}{1}\textsc{García} Cubas, Antonio. \emph{Escritos Diversos. De 1870-1874}. Imprenta <<Escalante>>, México, 1874, 422 pp

\hangpara{1cm}{1}\textsc{García} Díaz, Bernardo. \emph{La terminal ferroviaria de Veracruz}. Secretaría de Comunicaciones y Transportes"/Ferrocarriles Nacionales de México, México, 1996, 1"a Ed., 95 pp.
...
\hangpara{1cm}{1}\rule{1cm}{0.4pt} \emph{Jefes Políticos y regiones veracruzanas, 1880-1900}. Universidad Nacional Autónoma de México, México, 2000, Tesis doctoral en Historia, 474 pp.

\hangpara{1cm}{1}\textsc{Gonzalbo}, Pilar (Comp.) \emph{Historia de la familia}. Instituto Mora, México, 1993, 1"a ed., 263 pp.
...
\hangpara{1cm}{1}\textsc{Merino} Hernández, Noel. \emph{Las cofradías en Jalacingo, 1799-1873}. Universidad Veracruzana, Xalapa, 2003, Tesis de Licenciatura en Historia, 170 pp.
...
\hangpara{1cm}{1}\textsc{Ramírez} Lavoignet, David. \emph{Testimonios para una historia de Perote}. Editora del Gobierno del Estado, México, s"/f, 155 pp.
...
\hangpara{1cm}{1}\textsc{Skerritt} Gardner, David. \emph{Colonos franceses y modernización en el Golfo de México}. Universidad Veracruzana (Historias Veracruzanas), Xalapa, 1995, 1"a ed., 229 pp.
...
%\fancyhead[LO]{\small\sc fuentes consultadas}
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872-1910} % Centrados
\fancyhead[CO]{\small\sc apéndice} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\pagenumbering{arabic}
\setcounter{page}{137}
\section{Antiguas medidas españolas}
\begin{table}[H]
\centering
\begin{tabular}{@{}cc@{}}
\toprule
Unidad & \textsc{si}\textsu{*} \\
\midrule
Carga & {} \\
\bottomrule
\end{tabular}
\caption[Antiguas medidas españolas]{\textsu{*} Sistema Internacional de unidades.}
\label{tab:antiguas-medidas-españolas}
\end{table}
% INDICE ONOMÁSTICO
%\newpage
%\thispagestyle{plain}
