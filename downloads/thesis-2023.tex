...
%\fancyhead[LO]{\small\sc fuentes consultadas}
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872-1910} % Centrados
\fancyhead[CO]{\small\sc apéndice 1} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\pagenumbering{arabic}
\setcounter{page}{137}
...
%\fancyhead[LO]{\small\sc fuentes consultadas}
\fancyhead[CE]{\small\sc familia y poder. los villegas de jalacingo, 1872-1910} % Centrados
\fancyhead[CO]{\small\sc apéndice 2} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\pagenumbering{arabic}
\setcounter{page}{139}
...
\newcommand{\TuX}{T\kern -.1267em\lower .37ex\hbox {U}\kern -.105emX} % For TuX logo
\newpage
\pagestyle{empty}
